...
pub struct Operation {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub process_path: Option<Vec<u32>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub origin_process_path: Option<Vec<u32>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub origin_exe: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub origin_confidence: Option<String>,
    #[serde(default)]
