...
use cli::{
    ...
    RemoteCommand, ResolvedWatchArgs, RestoreArgs, RestoreCommand, RestoreTopArgs, RootAddArgs,
    RootCommand, RootSetArgs, SnapshotArgs, SyncCommand, UnmountArgs, WatchArgs,
};
use config::{
